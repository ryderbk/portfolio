    ...
    <section id="about" className="py-24 md:py-36" aria-label="About me">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 mb-12 md:mb-16 items-start">
          ...
          <motion.div {...fadeUp(0.15)} className="lg:col-span-4 order-1 lg:order-2 flex justify-center lg:justify-end w-full lg:mt-12">
            <div className="relative w-full max-w-[320px] md:max-w-[360px]">
              ...
              <div className="glass-card no-lift relative overflow-hidden rounded-2xl aspect-[3/4] p-0">
                <img
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-10">
          {/* Experience */}
          <motion.div {...fadeUp(0.1)} className="lg:col-span-5 flex flex-col">
            ...
            <div className="glass-card no-lift p-6 md:p-7 flex-1">
          ...
          <motion.div {...fadeUp(0.18)} className="lg:col-span-7">
            ...
            <div className="glass-card no-lift p-6 md:p-7 divide-y divide-border/60">
              {education.map((ed, i) => (
